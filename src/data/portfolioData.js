...
export const projects = [
  {
    ...
    description:
      "A full-stack notes management application with a React-based frontend and RESTful backend.",
    technologies: [
      "React.js",
      "Tailwind CSS",
      "Node.js",
    ...
    features: [
      ...
      "Integrated frontend and backend using REST APIs and Axios.",
      "Implemented authentication-related API handling and authorization headers.",
      "Designed a responsive user interface using React and Tailwind CSS.",
      "Integrated MongoDB for persistent application data storage.",
...

  {
    ...
    category: "Financial Data Modeling",
    description:
      "A structured personal finance tracking system designed to manage accounts, transactions, expenses, budgets, recurring bills, and investments.",
    technologies: ["Google Sheets", "Financial Data Modeling"],
    features: [
      "Structured accounts and transaction management.",
      "Designed an accounting-style transaction flow.",
      "Reduced duplicate expense entries through structured workflows.",
      "Implemented formulas and data validation for automated account balances.",
      "Automated transaction categorization.",
      "Designed a workflow for multiple bank accounts and credit cards.",
    ],
    github: null,
    liveDemo: null,
  },
