        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {skills.map((skillGroup, index) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group rounded-3xl border border-gray-200 bg-gray-50 p-6 transition-shadow duration-300 hover:shadow-xl dark:border-gray-800 dark:bg-gray-900"
            >
              {/* Category number */}
